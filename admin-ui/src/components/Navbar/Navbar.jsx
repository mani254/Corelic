...
const navItems = [
	...
	{ label: "Orders", icon: OrdersIcon, link: "/orders" },
	{ label: "Products", icon: ProductsIcon, link: "/products" },
	{ label: "Collections", icon: CollectionsIcon, link: "/collections" },
	{ label: "Brands", icon: BrandsIcon, link: "/brands" },
